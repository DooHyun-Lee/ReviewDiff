...
parser.add_argument('--apply_condition', default=True)
# Datset Configs
...
parser.add_argument('--test_interval', default=8000, type=int)
...
if __name__ == '__main__':
    ...
    inv_model = InverseDynamics(emb_dim=args.obs_dim, dropout_rate=args.dropout,
                             embedding_lookup=train_dataset.embedding_lookup)

    diffusion_model = TransformerDiffusion(tranformer_model, inv_model, horizon=args.horizon, obs_dim=args.obs_dim,
                                           num_diffusion_timesteps=args.num_diffusion_timesteps,
                                           apply_condition=args.apply_condition)

    trainer = Trainer(diffusion_model, train_dataset, eval_dataset, test_dataset, 
                      ...
                      test_interval=args.test_interval, device=args.device)
